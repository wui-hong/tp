...
import static seedu.spendnsplit.logic.commands.CommandTestUtil.VALID_TELEGRAM_HANDLE_AMY;
import static seedu.spendnsplit.logic.commands.CommandTestUtil.VALID_TELEGRAM_HANDLE_BOB;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline")
            ...
            .withPhone("94351253").withTelegramHandle("@Alice123")
            .withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432").withTelegramHandle("@Benson123")
            .withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street").withTelegramHandle("@Carl123").build();
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withPhone(null)
            .withEmail("cornelia@example.com").withAddress("10th street").withTags("friends")
            .withTelegramHandle("@Daniel123").build();
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withPhone("9482224")
            .withTelegramHandle(null).withEmail("werner@example.com").withAddress("michegan ave").build();
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withPhone("9482427")
            .withTelegramHandle("@Fiona123").withEmail(null).withAddress("little tokyo").build();
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withPhone("9482442")
            .withTelegramHandle("@George123").withEmail("anna@example.com").withAddress(null).build();

    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withPhone("8482424")
            .withTelegramHandle("@Hoon123").withEmail("stefan@example.com").withAddress("little india").build();
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withPhone("8482131")
            .withTelegramHandle("@Ida123").withEmail("hans@example.com").withAddress("chicago ave").build();
