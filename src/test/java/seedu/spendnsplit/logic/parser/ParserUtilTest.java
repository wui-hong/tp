...
import static seedu.spendnsplit.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    private static final String INVALID_COST = ".20.00";
    ...
    private static final String VALID_COST = "20.00";

    private static final String VALID_DESCRIPTION = "bread";
    ...
    public void parseAmount_validValueWithWhitespace_returnsTrimmedAmount() throws Exception {
        String amountWithWhitespace = WHITESPACE + VALID_COST + WHITESPACE;
        Amount expectedAmount = new Amount(VALID_COST);
    ...
    @Test
    public void parseDescription_invalidValueEmptyString_throwsParseException() {
