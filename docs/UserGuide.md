...
- Selecting Result Display: <kbd>ALT</kbd> (Windows) / <kbd>OPTION</kbd> (Mac) + <kbd>UP ARROW KEY</kbd>
- Selecting Persons List: <kbd>ALT</kbd> (Windows) / <kbd>OPTION</kbd> (Mac) + <kbd>LEFT ARROW KEY</kbd>
- Selecting Transactions List: <kbd>ALT</kbd> (Windows) / <kbd>OPTION</kbd> (Mac) + <kbd>RIGHT ARROW KEY</kbd>
- Selecting Command Box: <kbd>ALT</kbd> (Windows) / <kbd>OPTION</kbd> (Mac) + <kbd>DOWN ARROW KEY</kbd>
